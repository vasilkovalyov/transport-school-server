...
router.get("/blocks/team-education/publish", (req, res) => controller.publish(req, res));
router.get("/blocks/team-education/unpublish", (req, res) => controller.unpublish(req, res));
