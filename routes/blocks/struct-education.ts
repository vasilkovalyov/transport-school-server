...
router.get("/blocks/struct-education/publish", (req, res) => controller.publish(req, res));
router.get("/blocks/struct-education/unpublish", (req, res) => controller.unpublish(req, res));
