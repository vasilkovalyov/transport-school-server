...
router.patch("/block/about-us-update", (req, res) => controller.update(req, res));
router.get("/blocks/about-us/:page", (req, res) => controller.getBlock(req, res));
router.patch("/block/about-us/publish", (req, res) => controller.publish(req, res));
router.patch("/block/about-us/unpublish", (req, res) => controller.unpublish(req, res));
