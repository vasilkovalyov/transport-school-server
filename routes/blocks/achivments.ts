...
router.patch("/blocks/achivments/publish", (req, res) => controller.publish(req, res));
router.patch("/blocks/achivments/unpublish", (req, res) => controller.unpublish(req, res));
