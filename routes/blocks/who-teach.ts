...
router.patch("/block/who-teach-update", (req, res) => controller.update(req, res));
router.get("/blocks/who-teach/:page", (req, res) => controller.getBlock(req, res));
router.patch("/block/who-teach/publish", (req, res) => controller.publish(req, res));
router.patch("/block/who-teach/unpublish", (req, res) => controller.unpublish(req, res));
