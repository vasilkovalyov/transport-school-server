...
router.patch("/block/contact-form-update", (req, res) => controller.update(req, res));
router.get("/blocks/contact-form/:page", (req, res) => controller.getBlock(req, res));
router.patch("/block/contact-form/publish", (req, res) => controller.publish(req, res));
router.patch("/block/contact-form/unpublish", (req, res) => controller.unpublish(req, res));
