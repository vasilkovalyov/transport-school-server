...
router.patch("/block/benefits-update/:id", (req, res) => controller.update(req, res));
router.get("/blocks/benefits/:page", (req, res) => controller.getBlock(req, res));
router.get("/blocks/benefits/publish", (req, res) => controller.publish(req, res));
router.get("/blocks/benefits/unpublish", (req, res) => controller.unpublish(req, res));
