...
router.patch("/block/contacts-update/:id", (req, res) => controller.update(req, res));
router.get("/blocks/contacts/:page", (req, res) => controller.getBlock(req, res));
router.get("/blocks/contacts/publish", (req, res) => controller.publish(req, res));
router.get("/blocks/contacts/unpublish", (req, res) => controller.unpublish(req, res));
